...
const Footer = () => {
  return (
    <footer className='w-full mt-10 pt-5 border-t border-gray-200 border-solid bg-gray-400'>
      <div className='m-auto max-w-5xl h-40 text-xs p-5 flex gap-1 justify-center relative'>
