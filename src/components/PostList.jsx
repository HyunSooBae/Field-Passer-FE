      ...
      <div className="mx-[-15px] flex flex-wrap gap-[10px] pl-[10px]">
        {
          data.map((item, index) => {
            ...
            return (
              <div key={index} className="w-[calc((100%/2)-10px)] mm:w-[calc((100%/4)-10px)] px-[5px] py-[5px] mm:py-[10px] mb-[5px] mm:mb-[10px]">
                <Link to='./details/postName' className="flex flex-col mm:gap-[15px] gap-[10px]">
